...
import myenum.E_TimeUnit;
import tiles_interactive.InteractiveTile;
import tools.uTool_AssetSetter;
import tools.uTool_SpriteSetter;
...
public class GamePanel extends JPanel implements Runnable {
    ...
    public uTool_SpriteSetter uToolSpriteSetter = new uTool_SpriteSetter(this);
        ...
        if (gameState == E_GameState.PLAY){
            ...
            for (int i = 0; i<monster.length; i++) {
                if (monster[i] != null) {
                    ...
                    if(!monster[i].alive) {monster[i].checkDrop();monster[i] = null;}
